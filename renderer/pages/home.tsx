  ...
  return (
    <React.Fragment>
      ...
      <div className=" h-screen w-full bg-[url('../public/images/bg.svg')] bg-cover">
        <div className=" w-full h-[20%] flex flex-row items-center justify-center gap-6">
        ...
        <div className=" h-[80%] w-full text-center text-3xl font-extrabold text-[#002147]">
          <div className=" h-[15%]">
            <h1>HH:MM:SS</h1>
            <h1>MMM DD, YYYY</h1>
          </div>
          {student.map((item) => (
            <div
              key={item.student_id}
              className=" h-[85%] w-full flex flex-row bg-white bg-opacity-50"
            >
              ...
              <div className=" h-full w-[60%] text-[50px] flex flex-col gap-y-6 justify-center items-start uppercase">
                ...
                <h1 className=" text-[100px] mt-10 animate-pulse">YOU'RE IN !</h1>
              </div>
            </div>
          ))}
        </div>
